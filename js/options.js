...
console.log(resultInMinutes);
  ...
  refresh_list = function(result) {
	...
	var circleElem = '<div class="icons_style circle"><p>77</p></div>';
        ...
        var blueRefreshFlag = "<img id='flag_blue_" + key + "' data-checked='" + resultObject.checked + "' data-id='" + key + "' src='" + OPTIONS_THEME_BLUE_FLAG_ICON + "' class='icons_style' style='float:none; display:" + (resultObject.green_flag == 1 ? "none" : "grid") + "' type='image'/>";
        ...
        var judoRankElem = "<img id='judo_rank_" + key + "' data-id='" + key + "' src='" + LEVELS[resultObject.level].icon + "' style='margin-left:3px; float:none; display:" + (resultObject.green_flag == 1 ? "none" : "grid") + "' class='icons_style' type='image'/>";
